...
/* harmony import */ var just_debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
/* harmony import */ var morphdom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41);
/* harmony import */ var shopify_asyncview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26);
/* harmony import */ var _shopify_theme_addresses__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(42);
/* harmony import */ var rimg_shopify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2);
/* harmony import */ var _Forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var StaticCart = /*#__PURE__*/function () {
  function StaticCart(section) {
    ...
    this.forms = new _Forms__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"](this.$el);
  ...
  _createClass(StaticCart, [{
    ...
    value: function _didUpdate(response, thisTimeoutId) {
      ...
      shopify_asyncview__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].load(window.Theme.routes.cart_url, {
        view: '_ajax'
      }).then(function (_ref) {
        var html = _ref.html;
        ...
        rimg_shopify__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"].watch(_this4.cartItemList);

        _this4.forms.unload();

        _this4.forms = new _Forms__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"](_this4.$el);
    ...
    value: function _initShippingCalc() {
      ...
      this.shippingCountryProvinceSelector = new _shopify_theme_addresses__WEBPACK_IMPORTED_MODULE_5__[/* CountryProvinceSelector */ "a"](countrySelect.innerHTML);
...
//# sourceMappingURL=StaticCart.bundle.js.map?1595346696007