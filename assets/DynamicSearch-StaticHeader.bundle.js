...
/* harmony import */ var _pixelunion_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
/* harmony import */ var _Layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return dim; });
...
var animation = Object(_pixelunion_animations__WEBPACK_IMPORTED_MODULE_0__[/* transition */ "a"])({
  el: el,
  state: 'closed'
});
var openers = new Set();
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ LiveSearch_LiveSearch; });
...
var eventemitter2 = __webpack_require__(40);
...
var LiveSearch_LiveSearch = /*#__PURE__*/function () {
  function LiveSearch($els, settings) {
    ...
    this.animationFlyDown = Object(animations_es["a" /* transition */])({
      el: this.$flyDown.get(0),
      state: 'closed'
    });
    this.animationSearchResults = Object(animations_es["a" /* transition */])({
      el: this.$searchResults.get(0),
      state: 'closed'
    });
    this.animationTakeover = Object(animations_es["a" /* transition */])({
      el: this.$el[0],
      state: 'closed'
    });

    if (this.$quickLinks.length) {
      this.animationQuickLinks = Object(animations_es["a" /* transition */])({
  ...
  LiveSearch_createClass(LiveSearch, [{
    ...
    value: function _openTakeOver() {
      ...
      ScrollLock["a" /* default */].lock(this.$el[0]);
...
//# sourceMappingURL=DynamicSearch-StaticHeader.bundle.js.map?1595346696007