...
/* harmony import */ var _components_ProductGridItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28);
/* harmony import */ var _components_search_SearchForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var StaticSearch = /*#__PURE__*/function () {
  function StaticSearch(section) {
    ...
    $productItems.each(function (i, productItem) {
      _this.productItems.push(new _components_ProductGridItem__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]({
        el: productItem,
        id: _this.section.id,
        lazy: true
      }));
    });
    this.searchForm = new _components_search_SearchForm__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"](this.$searchField);
  }
...
//# sourceMappingURL=StaticSearch.bundle.js.map?1595346696007